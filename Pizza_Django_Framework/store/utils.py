import json
from .models import *
from ..accounts.models import PizzaUser
...
def cookieCart(request):
    ...
    for i in cart:
        ...
        try:
            ...
            item = {
                'id': pizza.id,
                'product': {'id': pizza.id, 'name': pizza.name, 'price': pizza.price,
                            'imageURL': pizza.image_url}, 'quantity': cart[i]['quantity'], 'get_total': total,
            }
            items.append(item)
